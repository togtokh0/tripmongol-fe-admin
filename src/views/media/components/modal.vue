...
<script >
import Upload_featuredImage from "../../../components/fileupload/one/image.vue";
...
export default defineComponent({
  ...
  data() {
    return {
      form: {
        image: "/uploads/holidays/image/png/6304333108857ef633a9cc92.png",
        about_en: "about_en",
        about_mon: "about_mon",
      },
